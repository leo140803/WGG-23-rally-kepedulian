...
<div class="container">
    <h1 class="h1 text-center mb-5">Routes</h1>
            ...
            <table class="table table-hover table-striped">
                ...
                <tbody class="table-group-divider">
                    ...
                    <tr>
                        <td><?= $i+1 ?></td>
                        <td>
                            <a href="#" editable-url="<?= site_url("panitia/rbac/addRoute/" . $route['id']) ?>" editable="true" editable-col="nama"><?= $route['nama'] ?></a>
                        </td>
                        <td>
                            <a href="#" editable-url="<?= site_url("panitia/rbac/addRoute/" . $route['id']) ?>" editable="true" editable-col="route"><?= $route['route'] ?></a>
                        </td>
                        <td>
                            <?= form_open("panitia/rbac/addRoute/" . $route['id']); ?>
