...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  ...
  <div class="inputBox d-flex justify-content-center align-items-center mt-5 pt-5">
    <?= form_open(site_url("/panitia/pelanggaran/TambahPasals")); ?>
    <!-- <div class="text">
      <label> Masukkan Bab Pasal: </label>
    ...
    <div class="input">
      ...
      <input type="text" name="babPasal" class="form-control mb-3" required>
      
      <label> Masukkan Keterangan Pasal: </label>
      
      <input type="text" name="keteranganPasal" class="form-control mb-3" required>
     
      <label> Masukkan Jumlah Poin: </label>
      
      <input type="text" name="jumlahPoin" class="form-control mb-3" required>
