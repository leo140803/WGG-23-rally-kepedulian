...
<div class="container">
    <h1 class="text-center my-5">Data Fakultas</h1>
        ...
        <div class="col-sm-12">
            <table class="table table-striped" id="data">
                <thead>
                    ...
                    <?php foreach($fakultas[0] as $key => $value): ?>
                ...
                <tbody>
                    <?php foreach($fakultas as $i => $fk): ?>
                        <tr class="<?= isset($edit) && isset($fk['deleted_at']) ? "table-danger" : "" ?>">
                            <td><?= $i+1 ?></td>

                            <?php foreach($fk as $key => $value): ?>
                                <?php if(in_array($key, ['id', 'created_at', 'updated_at', 'deleted_at'])): continue; else: ?>
                                    <td> <?= $value; ?> </td>
                                <?php endif; ?>
                            <?php endforeach; ?>
